...
struct Memory: sc_module
{
  ...
  void trigger_thread()
  {
	  ...
	  //trigger both events in the same time so satisfy the wait from the watcher_p() which waits for both
  ...
  void watcher_thread()
  {
	  cout << "Cowtwo Memory watcher_thread"<<endl;
	  wait(my_event_1_ev);
  ...
  virtual void b_transport( tlm::tlm_generic_payload& trans, sc_time& delay )
  {
    ...
    cout << "CowTwo Memory b_transport at time: " << sc_time_stamp()<< " adr="<<hex<<(adr*4) << endl;
  ...
  sc_event my_event_1_ev;
  sc_event my_event_2_ev;
  sc_event my_event_3_ev;
  sc_event my_event_4_ev;
  sc_event my_event_5_ev;
  sc_event my_event_6_ev;
};
